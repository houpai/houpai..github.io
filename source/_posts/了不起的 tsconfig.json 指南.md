...
![了不起的 tsconfig.json 指南.png](https://segmentfault.com/img/remote/1460000022809335)
...
![tsconfig.json 文件结构（顶层属性）.png](https://segmentfault.com/img/remote/1460000022809334)

![了不起的 tsconfig.json 指南.png](https://segmentfault.com/img/remote/1460000022809332)



### 2. 按功能分类

![tsconfig.json 文件结构（功能）.png](https://segmentfault.com/img/remote/1460000022809333)
